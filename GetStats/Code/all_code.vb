...
' macro version
    Const macro_name As String = "GetStats Pro v1.11.1"
...
Option Explicit
Option Base 1
    Const addin_file_name As String = "GetStats_BackTest_v1.11.1.xlsm"
    Const rep_type As String = "GS_Pro_Single_Core"
    Const macro_ver As String = "GetStats Pro v1.11.1"
